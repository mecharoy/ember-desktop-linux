...
- **Local model.** [Ollama](https://ollama.com/download) on your computer. Ember starts it and keeps your model loaded while Ember is open, and unloads it when you quit. Nothing leaves the computer.
